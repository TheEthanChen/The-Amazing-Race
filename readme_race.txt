 ...
 *********************************************************************/
Did not use the Penn Pennant Picture or the Princeton Pennant Picture.
    Used a Square and a Cirlce with randomized eyes and mouth.
When creating the StampSketch, created randomized "stars" and a pool only when
    entering a certain ASCII value corresponding to the key typed (try 
    continously typing "s").
